...
import quizRegular from "../../hooks/quiz/quiz_regular"
import SingleAnswerMultipleChoiceOption from "../../components/choices/answer-mode/single_answer_multiple_choice_option"
import MultipleAnswerMultipleChoiceOption from "../../components/choices/answer-mode/multiple_answer_multiple_choice_option"
import InputField from "../../components/field/input_field"
import TrueOrFalseOption from "../../components/choices/answer-mode/true-or-false-option"

function OnQuizRegular() {

    const { timeLeft, question, currentQuestion, answerAttemptValue, handleCurrentQuestionChange, isAnswerAttemptSelected, handleCheckBoxAnswer, handleRadioAnswer, handleEssayAnswer, submit } = quizRegular()
