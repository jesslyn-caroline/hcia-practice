...
import NewQuiz from "../../hooks/quiz/newQuiz"

function QuizMenu() {
    const { questionCount, handleQuestionCountChange, quizType, handleQuizType, timePerQuestion, handleTimePerQuestionChange, timeLimit, handleTimeLimitChange, startQuiz, isOnLoad } = NewQuiz()
