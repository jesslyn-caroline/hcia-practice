...
import quizFlash from "../../hooks/quiz/quiz_flash"
...
function OnQuizFlash() {
    ...
    const { currentQuestion, question, timeToNext, isAnswerAttemptSelected, answerAttemptValue, handleCheckBoxAnswer, handleRadioAnswer, handleEssayAnswer, score, submit } = quizFlash()
