...
function SingleAnswerMultipleChoice( {optionsValue, isOptionsSelected, handleOptionValueChange, handleIsOptionsSelectedChange, optionsErrMessage, noAnswerErrMessage} : Props) {
